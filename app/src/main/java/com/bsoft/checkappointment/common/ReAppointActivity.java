...
public class ReAppointActivity extends BaseAppointOrCancleActivity {
                ...
                .subscribe(new BaseObserver<String>() {
                    ...
                    public void onNext(String result) {
                        ...
                        if (resultVo.code == 1 || resultVo.code == 200) {
                            Intent intent = new Intent(ReAppointActivity.this, AppointOrCancleResultActivity.class);
                            intent.putExtra("opType", 1);//预约
                            startActivity(intent);
                            ReAppointActivity.this.finish();
                        } else {
