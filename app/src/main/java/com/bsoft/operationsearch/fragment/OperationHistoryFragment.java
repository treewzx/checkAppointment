 ...
 */
public class OperationHistoryFragment extends BaseFragment {
    ...
    private void initAdapter() {
        if (recyclerView != null) {
            mAdapter = new CommonAdapter<OperationVo>(mContext, R.layout.recycle_item_operation_history, mOperationList) {
                @Override
                protected void convert(ViewHolder holder, OperationVo operationVo, int position) {
                    holder.setText(R.id.operation_department_tv, operationVo.getDepartmentName())
                            ...
                            .setText(R.id.operation_time_tv, operationVo.getOperativeTime());
